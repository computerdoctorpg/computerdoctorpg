...
const s = StyleSheet.create({
  ...
  titleMain: { fontSize: 12, ...B, textTransform: 'uppercase' },
  ...
  dispatchNum: { ...B, color: '#000', fontSize: 9 },
  ...
  dateValue: { fontSize: 8, ...B, textAlign: 'right' },
  ...
  colTitle: { fontSize: 6, ...B, textTransform: 'uppercase', color: PDF_COLORS.grayLight, borderBottomWidth: 0.5, borderBottomColor: '#d1d5db', paddingBottom: 3, marginBottom: 4 },
  clientName: { fontSize: 8.5, ...B, marginBottom: 2 },
  line: { fontSize: 7.5, marginBottom: 1 },
  deviceName: { fontSize: 8.5, ...B, marginBottom: 4 },
  ...
  workTitle: { fontSize: 8.5, ...B, textTransform: 'uppercase', marginBottom: 5 },
  blockTitle: { fontSize: 6, ...B, textTransform: 'uppercase', color: PDF_COLORS.gray, marginBottom: 2 },
  ...
  flagText: { fontSize: 7, ...B },
  flagMuted: { color: PDF_COLORS.grayLight },
  costsTitle: { fontSize: 8, ...B, textTransform: 'uppercase', marginBottom: 4 },
  tableHead: { flexDirection: 'row', borderBottomWidth: 1.5, borderBottomColor: '#e5e7eb', paddingBottom: 3, marginBottom: 1 },
  thLeft: { flex: 2, fontSize: 6, ...B, color: PDF_COLORS.gray, textTransform: 'uppercase' },
  thRight: { flex: 1, fontSize: 6, ...B, color: PDF_COLORS.gray, textTransform: 'uppercase', textAlign: 'right' },
  ...
  totalLabel: { flex: 2, fontSize: 8, ...B, paddingLeft: 3 },
  totalValue: { flex: 1, fontSize: 10, fontFamily: 'Courier-Bold', textAlign: 'right', paddingRight: 3 },
  warning: { textAlign: 'center', color: '#dc2626', fontSize: 7, ...B, textTransform: 'uppercase', marginTop: 8, marginBottom: 8, lineHeight: 1.25 },
  ...
  signLabel: { fontSize: 6, ...B, textTransform: 'uppercase', marginBottom: 14 },
